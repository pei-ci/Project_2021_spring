...
var event_13 = {"text":"長庚大學內的便利商店會有學生優惠，請問是打幾折？\nA.9折\nB.85折\nC.8折",
				...
				"rewardA":10,"rewardB":2,"rewardC":2}	
var event_14 = {"text":"請問木棧道總共有幾階階梯（只算往上的）？\nA.232\nB.212\nC.252",
